...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full min-h-[600px] flex flex-col items-center justify-center bg-black overflow-hidden relative"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center min-h-[600px]">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 via-white to-neutral-400 animate-pulse flex items-center justify-center z-10 shadow-[0_0_30px_rgba(255,255,255,0.3)]">
