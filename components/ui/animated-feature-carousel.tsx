...
const steps: readonly Step[] = [
  {
    ...
    description: "Connect your AI agent to WhatsApp, Instagram, Facebook, and your website instantly. One brain, everywhere your customers are.",
  },
  {
    id: "2",
    name: "Step 2",
    title: "Custom AI Training",
    description: "We train your agent on your business data, documents, and FAQs. It learns your brand voice and provides accurate answers 24/7.",
  },
  {
    id: "3",
    name: "Step 3",
    title: "Lead Qualification",
    description: "Your agent automatically qualifies leads, books appointments, and captures contact info, feeding it directly to your team.",
  },
  {
    id: "4",
    name: "Step 4",
    title: "Live Handover",
    description: "When a complex issue arises, your AI agent seamlessly transfers the chat to a human team member with full context.",
  },
]
      ...
      <div className="relative w-full overflow-hidden rounded-3xl border border-neutral-200 bg-white transition-colors duration-300 dark:border-neutral-800 dark:bg-neutral-900">
        <div className="m-10 min-h-[450px] w-full">
          <AnimatePresence mode="wait">
            ...
            >
              <motion.div
                className="text-sm font-semibold uppercase tracking-wider text-white/70 dark:text-white/60"
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                    ...
                    return (
                        <motion.li key={step.name} initial="inactive" animate={isCurrent ? "active" : "inactive"} variants={stepVariants} transition={{ duration: 0.3 }} className="relative" >
                            <button
                                type="button"
                                className={cn(
                                    "group flex items-center gap-2.5 rounded-full px-3.5 py-1.5 text-sm font-medium transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white/50 dark:focus-visible:ring-offset-black",
                                    isCurrent 
                            ...
                            >
                                <span className={cn(
                                    ...
                                    isCompleted 
                                        ? "bg-white text-black dark:bg-white dark:text-black" 
                                        : isCurrent 
                                            ? "bg-neutral-400 text-black dark:bg-neutral-400 dark:text-black" 
